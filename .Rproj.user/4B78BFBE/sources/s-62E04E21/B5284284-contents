...
#'
#' @description Method for estimating the intensity values M and A, considering p spots/genes and n microarray slides.
#'  If estimator is set as 'second-order', then an estimator that takes into account pixel-level inaccuracies is used.
#'
...
#'
#' @description Data-driven parameter selection method that is parsimonious and considers
...
#'
#' @references{
#'   \insertRef{liu2013heteroscedasticity}{omicsMA}
#' }
#'
#' @param M.mean a vector with the M values for the p genes.
#' @param A.mean a vector with the A values for the p genes.
#' @param eva.values a vector with bandwith values to be considered by the LOWESS parameter selection method.
#' @param debug Logical indication if you want to view logs of the execution.
#' @param save.objs Logical indicating if you want to save objects with partial results.
#' @param save.plots Logical indicating if you want to generate the M plots
